...
# secconfig/scripts/.work-encrypted-config.bash. Caller sets EEC_MSG_PREFIX
# before source.
#
# Shared interactive helpers for edit-encrypted.sh (OpenSSL) and the sops
# scripts (new-encrypted-config.sh / edit-encrypted-config.sh).
